...
import {columns, users, statusOptions} from "./users_data";
...
const INITIAL_VISIBLE_COLUMNS = ["id", "name", "idade", "score", "status", "actions"];
...
export default function Utilizadores() {
            ...
            case "score":
                return (
                    <div className="flex flex-col">
                        ...
                        <p className="text-bold text-tiny capitalize text-default-400">pontos</p>
                    </div>
                );
            case "status":
                return (
        ...
        return (
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-default-400 text-small">Total {users.length} utilizadores</span>
                </div>
            </div>
        );
    }, [
    ...
    return (
        ...
        >
            ...
            <TableBody emptyContent={"Nenhum utilizador encontrado"} items={sortedItems}>
                {(item) => (
